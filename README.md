...
| `MultirateKF_Simple.ipynb` | Basic optimal Kalman filter design for 1st order system| Minimize trace(P_e) |
| `MultirateKF_Simple.py` | Basic optimal Kalman filter design for 1st order system| Minimize trace(P_e) |
